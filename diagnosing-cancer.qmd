...
Build a more complex model to predict the diagnosis using five predictors of your choosing, then calculate the testing and training $R^2$. Is there evidence that your model is overfitting? How can you tell one way or the other?
...
Calculate the total number of false positives in the test data set when using your simple model with only one variable.


#### Question 12

What can you change about your classification rule to lower the number of false negatives? Make this change and calculate the new number of false positives.
